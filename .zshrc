...
ZSH_THEME_RANDOM_CANDIDATES=( "xiong-chiamiov" "xiong-chiamiov-green" "xiong-chiamiov-purple" "xiong-chiamiov-red" "xiong-chiamiov-yellow" )
...
# Ctrl + Shift + O - Seperate Horizontaly
# Ctrl + Shift + E - Seperate Verticaly
# Ctrl + Shift + W - Close active Terminal
# Ctrl + Shift + X - Close all Terminal
